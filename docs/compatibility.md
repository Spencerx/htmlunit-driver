...
Starting with Selenium 4.5 we use the same version numbers for the driver - e.g. HtmlUnit-Driver 4.45.0
is for Selenium 4.45.0.


***htmlunit3-driver***

**Note:** As of version 4.44.0 **JDK 17** is required


| selenium | htmlunit-driver | htmlunit   |    artifactId    |  JDK   |
|----------|-----------------|------------|------------------|--------|
| 4.45.0   | **4.45.0**      | **5.2.0**  | htmlunit3-driver | **17** |
| 4.44.0   | 4.44.0          | 5.0.0      | htmlunit3-driver |   17   |
| 4.43.0   | 4.43.0          | 4.21.0     | htmlunit3-driver |   11   |
| 4.42.0   | 4.42.0          | 4.21.0     | htmlunit3-driver |   11   |
